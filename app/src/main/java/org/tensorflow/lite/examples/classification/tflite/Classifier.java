...
public abstract class Classifier {
  ...
  public enum Model {
    ...
    QUANTIZED_AUTOML_EDGE // TODO added
  }
  ...
  public static Classifier create(Activity activity, Model model, Device device, int numThreads)
    ...
    } else if (model == Model.QUANTIZED_AUTOML_EDGE) { // TODO added
      return new ClassifierQuantizedAutoMLEdge(activity, device, numThreads);
    } else {
